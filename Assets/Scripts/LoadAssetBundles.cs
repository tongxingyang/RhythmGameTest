...
public class LoadAssetBundles : MonoBehaviour
{
    ...
    #endif
    #if UNITY_EDITOR
        bundlePath = Path.Combine("Assets", "AssetBundles/StandaloneWindows64");
    #endif
    }
    ...
    public AsyncOperation LoadVenueBundle(string venueName)
    {
        ...
        // vemueMaterials = AssetBundle.LoadFromFile(Path.Combine(bundlePath, venueName + "_materials"));
