...
namespace Doozy.Engine.Utils
{
    public static class ScriptUtils
    {
        ...
        public static string DecodeString(string data)
        {
            ...
            byte[] bytes = System.Convert.FromBase64String(data.Substring(BASE64_IDENTIFIER.Length));
        ...
        public static string EncodeString(string data)
        {
            ...
            return BASE64_IDENTIFIER + System.Convert.ToBase64String(Encoding.UTF8.GetBytes(data));
        }
    }
}