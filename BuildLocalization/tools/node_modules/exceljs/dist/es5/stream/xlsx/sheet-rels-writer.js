...
SheetRelsWriter.prototype = {
  ...
  _writeRelationship: function _writeRelationship(relationship) {
    ...
    if (relationship.TargetMode) {
      this.stream.write("".concat('<Relationship' + ' Id="').concat(rId, "\"") + " Type=\"".concat(relationship.Type, "\"") + " Target=\"".concat(utils.xmlEncode(relationship.Target), "\"") + " TargetMode=\"".concat(relationship.TargetMode, "\"") + '/>');
    } else {
      this.stream.write("".concat('<Relationship' + ' Id="').concat(rId, "\"") + " Type=\"".concat(relationship.Type, "\"") + " Target=\"".concat(relationship.Target, "\"") + '/>');
    }
